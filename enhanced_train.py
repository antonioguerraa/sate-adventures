...
def download_wikitext():
    ...
    if not wikitext_path.exists():
        ...
        zip_path = data_path / "wikitext-2-raw-v1.zip"
        ...
        # Combine train, valid, test into one file
        with open(wikitext_path, 'w') as outfile:
            for split in ['train', 'valid', 'test']:
                with open(data_path / f"wikitext-2-raw/wiki.{split}.raw", 'r') as infile:
...
def train():
    ...
    wikitext_path = download_wikitext()
